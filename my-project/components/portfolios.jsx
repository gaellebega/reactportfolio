...
// function Portfolios() {
//   return (
//    <section id='portfolios'className="w-full h-[800px] py-20 flex border-b-[1px] border-b-black flex flex-center">
//  {/* <div className="flex  items-center justify-center gap-8 my-10 w-full  flex-wrap"> */}
...
//     {/* <div className="grid grid-cols-1 sm:grid-cols- lg:grid-cols-2 gap-2 "> */}
